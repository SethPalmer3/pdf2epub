class Character:
    ...
    def vertical_intersection(self, other: "Character") -> bool:
        return (
            self.top_side >= other.top_side >= self.bottom_side
            or other.top_side >= self.top_side >= other.bottom_side
            or (
                self.top_side >= other.top_side
                and self.bottom_side <= other.bottom_side
            )
            or (
                other.top_side >= self.top_side
                and other.bottom_side <= self.bottom_side
            )
            or self.top_side == other.top_side
            or self.bottom_side == other.bottom_side
        )
...
class LineGenerator:
    def __init__(
        self, character_generator: CharacterConverter, relative_mode: bool
    ) -> None:
        """
